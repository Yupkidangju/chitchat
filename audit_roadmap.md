...
## 4. Phase 2: Provider Adapter + Capability Mapper
...
7개 설정 화면(Provider, ModelProfile, UserPersona, AIPersona, Lorebook, Worldbook, ChatProfile)의 CRUD가 동작하고, 네오-브루탈리즘 기본 테마가 적용된 PySide6 UI가 렌더링된다.
...
## 6. Phase 4: Prompt Assembly + Lore Matching
...
## 7. Phase 5: Chat Streaming + Inspector
...
| PySide6 OS별 패키징 차이 | 빌드 실패 | P6 | OS별 hidden-import 추가, CI 분리 |
